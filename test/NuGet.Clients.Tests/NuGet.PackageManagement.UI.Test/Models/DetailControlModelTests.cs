...
{
    public abstract class DetailControlModelLocalTestBase : IClassFixture<LocalPackageSearchMetadataFixture>, IDisposable
    {
        ...
        public DetailControlModelLocalTestBase(LocalPackageSearchMetadataFixture testData)
        {
            _testData = testData;
...
#pragma warning restore VSSDK005 // Avoid instantiating JoinableTaskContext
    ...
    public abstract class DetailControlModelV3TestBase : IClassFixture<V3PackageSearchMetadataFixture>, IDisposable
    {
        ...
        public DetailControlModelV3TestBase(V3PackageSearchMetadataFixture testData)
        {
            _testData = testData;
            var testVersion = new NuGetVersion(0, 0, 1);
            _testViewModel = new PackageItemListViewModel()
...
#pragma warning restore VSSDK005 // Avoid instantiating JoinableTaskContext
    ...
    public class PackageDetailControlModelLocalTests : DetailControlModelLocalTestBase
    {
        private readonly PackageDetailControlModel _testInstance;

        public PackageDetailControlModelLocalTests(LocalPackageSearchMetadataFixture testData)
            : base(testData)
        {
    ...
    public class PackageDetailControlModelV3Tests : DetailControlModelV3TestBase
    {
        private readonly PackageDetailControlModel _testInstance;

        public PackageDetailControlModelV3Tests(V3PackageSearchMetadataFixture testData)
            : base(testData)
        {
            var solMgr = new Mock<ISolutionManager>();
            _testInstance = new PackageDetailControlModel(
        ...
        [Fact]
        public void MaxVulnerabilitySeverity_Calculated()
        {
            Assert.True(_testInstance.IsPackageVulnerable);
        }
    }

    public class PackageSolutionDetailControlModelLocalTests : DetailControlModelLocalTestBase
    {
        private readonly PackageSolutionDetailControlModel _testInstance;

        public PackageSolutionDetailControlModelLocalTests(LocalPackageSearchMetadataFixture testData)
            : base(testData)
        {
            var solMgr = new Mock<ISolutionManager>();
