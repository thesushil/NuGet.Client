...
namespace NuGet.VisualStudio.Common.Test
{
    public class OutputConsoleLoggerTests
    {
        public class Constructor : TestsRequiringJoinableTaskFactoryBase
        {
            ...
            {
                var exception = Assert.Throws<ArgumentNullException>(() => new OutputConsoleLogger(visualStudioShell: null, new Mock<IOutputConsoleProvider>().Object, new Lazy<IErrorListTableDataSource>()));
            ...
            {
                var exception = Assert.Throws<ArgumentNullException>(() => new OutputConsoleLogger(new Mock<IVisualStudioShell>().Object, consoleProvider: null, new Lazy<IErrorListTableDataSource>()));
            ...
            public void Subscribes_to_BuildBegin_events()
            {
                ...
                var logger = new OutputConsoleLogger(visualStudioShell.Object, new Mock<IOutputConsoleProvider>().Object, new Lazy<IErrorListTableDataSource>());
            ...
            public void BuildBegin_event_clears_error_list_entries()
            {
                ...
                var errorListTableDataSource = new Mock<IErrorListTableDataSource>();

                var logger = new OutputConsoleLogger(visualStudioShell.Object, new Mock<IOutputConsoleProvider>().Object, new Lazy<IErrorListTableDataSource>(() => errorListTableDataSource.Object));

                onBuildBegin();
                errorListTableDataSource.Verify(eltds => eltds.ClearNuGetEntries(), Times.Exactly(1));
            }
            ...
            public void Creates_package_manager_console()
            {
                ...
                var logger = new OutputConsoleLogger(new Mock<IVisualStudioShell>().Object, outputConsoleProvider.Object, new Lazy<IErrorListTableDataSource>());
